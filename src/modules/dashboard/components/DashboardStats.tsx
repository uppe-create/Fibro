...
import { formatCpfByPermission, getDocumentIssues, getNextOperationalAction } from '@/lib/dashboard-utils';
                ...
                <div key={reg.id} className="rounded-2xl border border-[#e3e9ef] bg-[#f8fafc] p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-[#617184]">{formatCpfByPermission(reg.cpf, canViewFullCpf)} - {getStatusLabel(reg.status)}</p>
                    </div>
