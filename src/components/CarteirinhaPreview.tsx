...
function formatManualSignature(signature?: string) {
            ...
            <div className="flex flex-col justify-between">
              <div className="space-y-2">
                ...
                <div className="border border-[#d7e2ed] bg-[#f8fbfd] p-2">
                  <p className="text-[5px] font-black uppercase text-[#47617d]">Codigo manual</p>
                  <p className="mt-1 font-mono text-[8px] font-black tracking-[0.08em] text-[#17324d]">
                    {formatManualSignature(registration.visualSignature)}
                  </p>
                  <p className="mt-0.5 text-[4.6px] font-bold uppercase text-[#6b7d90]">Usar com Registro CIPF</p>
                </div>
              </div>
